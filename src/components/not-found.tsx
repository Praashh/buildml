...
function GlitchText({ children }: { children: React.ReactNode }) {
    return (
        <span className="relative inline-block">
            ...
            <span
                className="absolute left-[2px] top-0 -z-10 text-green-400 opacity-70"
                style={{
            ...
            <span
                className="absolute left-[-2px] top-0 -z-10 text-green-600 opacity-70"
                style={{
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black p-4">
            ...
            <div className="relative z-10 max-w-2xl text-center">
                ...
                <div className="mb-8">
                    <h1 className="font-mono text-[8rem] font-bold leading-none tracking-tighter text-white md:text-[12rem]">
                    ...
                    <div className="rounded-lg border border-green-500/20 bg-black/50 p-6 backdrop-blur-sm">
                        ...
                        <div className="space-y-2 text-sm">
                            <p className="text-gray-500">
                                <span className="text-green-500">$</span> navigate
                                --path &quot;/requested-page&quot;
                            </p>
                ...
                <Link href="/">
                    <Button
                        size="lg"
                        className="group rounded-full bg-white px-8 py-6 text-base font-semibold text-black transition-all hover:bg-green-400 hover:shadow-lg hover:shadow-green-500/20"
                    >
